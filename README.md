...
### [Download](https://github.com/arfshl/Trisquel-wsl/releases)
...
## Install
#### 1. [Download here](https://github.com/arfshl/Trisquel-wsl/releases)

#### 2. Double-click the .wsl file to install it with default name

#### 3. Or install from elevated cmd to customize the name

     wsl --install --from-file <path>/trisquel-amd64.wsl  --name <machine-name>
